                ...
                <MyTabs themes={['Решето Эратосфена', 'Алгоритм Евклида', 'Возведение в степень по модулю', 'Диофантовы уравнения', 'Игра ним', 'Преобразование Фурье и работа с полиномами', 'Алгоритм БПФ', 'Вычисление свёртки']}>
                    ...
                    <Article data = {[
                     ...
                     <Article data = {[
                        ...
                        состояния игры, начав с проигрышных состояний, в которых нет ни одного возможного хода. На рисунке показана классификация состояний
                        ...
                        палочки, а в состоянии 7 – только одну палочку. На рисунке состояния 1…9 показаны в виде
                        графа состояний, вершинами которого являются состояния, а ребрами – переходы между
                        ними.`, 'p'],
                        [`В этой игре конечным состоянием всегда является 1 – проигрышное, потому что в нем нет допустимых ходов. На рисунке показана классификация состояний 1…9. Оказывается, что в этой игре все четные состояния
