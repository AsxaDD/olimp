...
import AcmpTasks from "../acmp_tasks";
import MyTabs from "../../baza/MyTabs";
import Question from "../question";
import MySyntaxHightlighter from "../../baza/Codeblocks";
                    ...
                    <div className="flex__cont__for__articles">
                        <div className="article" id="a0">
                            <div className="text">
                                ...
                                <p>При поиске в ширину (breadth-first search – BFS) вершины графа посещаются в порядке возрастания расстояния от начальной вершины. Следовательно, используя поиск в ширину, мы сможем вычислить расстояния от
                                    начальной вершины до всех остальных.</p>
                                ...
                                <MySyntaxHightlighter code={code1} />
