                ...
                <MyTabs themes={['Приветствие', 'Основные понятия', 'Поиск в ширину', 'Поиск в глубину', 'Алгоритм Дейкстры',
                    ...
                    <div className="flex__cont__for__articles">
                        <div className="article" id="a0">
                            <div className="text">
                                <p>
                                Приветствуем, будущий олимпиадник! Если ты уже начал изучать программирование или только собираешься, то поздравляю, ты сделал очень правильный выбор! Олимпиадное программирование - это увлекательный и захватывающий мир, в котором ты сможешь проявить свои навыки и творческий потенциал.
                                </p>
                                ...
                                <p><b>В этом и других блоках материалы взяты из книг "Спортивное программирование" Стивена Халима и Феликса Халима, "Олимпиадное программирование" Антти Лааксонена, а также с разлиных сайтов соответствующей тематики, википедии и из общедоступных конспектов студентов технических вузов.</b></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex__cont__for__articles">
                        <div className="article" id="a0">
                            <div className="text">
                                ...
                                число ребер, начинающихся в вершине. На рисунке показаны полустепени захода и исхода для каждой вершины графа. Например, для вершины 2
                                ...
                                Граф называется двудольным, если его вершины можно раскрасить в два
                                    ...
                                    цикла с нечетным числом вершин. На рисунке изображены двудольный
